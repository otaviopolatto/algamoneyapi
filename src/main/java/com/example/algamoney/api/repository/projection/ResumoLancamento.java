...
public class ResumoLancamento {
	...
	private String categoria; /* Retorna apenas o nome da categoria */
	private String pessoa; /* Retorna apenas o nome da pessoa */
	
	/* Construtor gerado pois na hora da implementação da consulta na criteria do JPA é utilizado este
	 * construtor para criar um novo ResumoLancamento */
